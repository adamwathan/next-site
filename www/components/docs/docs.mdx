...
<details>
  ...
  <ul>
    <li>
      <a href="/examples/public-file-serving">Public file serving</a>
    </li>
  </ul>
</details>
...
- Commonly used to implement server side rendering for css-in-js libraries like [styled-components](https://github.com/zeit/next.js/examples/with-styled-components) or [emotion](/examples/with-emotion). [styled-jsx](https://github.com/zeit/styled-jsx) is included with Next.js by default.
